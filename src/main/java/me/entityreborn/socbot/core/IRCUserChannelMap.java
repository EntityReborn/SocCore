 ...
 * @author marrink
 */
public class IRCUserChannelMap implements UserChannelMap {
     ...
     */
    public IRCUserChannelMap(int initialCapacity) {
     ...
     * @param loadFactor
     */
    public IRCUserChannelMap(int initialCapacity, float loadFactor) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof IRCUserChannelMap) {
            IRCUserChannelMap other = (IRCUserChannelMap) obj;
